...
extern	 volatile UINT8 rfend;  

//RF4432配置口定义
#define	RF4432_SDO 	P06_DOUT	//SPI数据输出
#define	RF4432_SDI 	P05_DOUT	//SPI数据输入
#define	RF4432_SCLK P07_DOUT    //SPI时钟输入端口
#define	RF4432_SEL 	P04_DOUT 	//SPI片选
#define	RF4432_IRQ 	P32_DOUT 	//SI4432工作状态指示端口
#define	RF4432_EN 	P41_DOUT 	//SI4432工作使能   

VOID RF4432_SetRxMode(VOID); 
VOID RF4432_Tx(UINT8 *packet,UINT8 length);
VOID Init_RF4432(UINT8 n);
